Feature: Global Configuration Setting 3: The system shall support setting Remote API URI.
         As a REDCap end user I want to see that the Remote API URI works as expected.

      Scenario: Global Configuration Setting 3: The system shall support setting the Remote API URI.
   #Active module in the control center.
      ...
      When I enter "http://127.0.0.1/api/" into the field labeled "Remote API URI:"
   ...
   #SETUP Turning on EM at the source project
      ...
      #Does this need to be entered here if on the global configuration?
      And I click on the button labeled "Save"
