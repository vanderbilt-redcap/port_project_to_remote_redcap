Feature: Global Configuration Setting 2: The system shall support setting Local Memory Limit (MB).
         As a REDCap end user I want to see that the Local Memory Limit (MB) works as expected.

      Scenario: Global Configuration Setting 2: The system shall support setting Local Memory Limit (MB).
   #Active module in the control center.
      ...
      When I enter "0" into the field labeled "Local Memory Limit (MB):"
